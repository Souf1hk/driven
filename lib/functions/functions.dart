...
//base url
String url =
    'https://atmob.co/'; //add '/' at the end of the url as 'https://url.com/'
String mapkey =
    (platform == TargetPlatform.android) ? 'AIzaSyCr0L1GArNCTc_bNZKEOktFJYC6SbMOxbk' : 'ios map key';
...
getCountryCode() async {
  ...
  try {
    ...
    if (response.statusCode == 200) {
      ...
      // Set Morocco as the default country
      int moroccoIndex = countries.indexWhere((element) => element['dial_code'] == '+212');
      phcode = (moroccoIndex != -1) ? moroccoIndex : 
